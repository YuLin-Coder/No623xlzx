...
<div class="page-container">
	<form action="TeacherServlet?action=add" method="post" enctype="multipart/form-data"  class="form form-horizontal" >
	...
	<%--	Teacher(Integer id, String tno, String pwd, String name, String sex, String major, String detail, String phone)--%>
		<div class="row cl">
			...
			<div class="formControls col-xs-3 col-sm-3">
				<input type="text" class="input-text" value="" placeholder="请输入工号" id="tno" name="tno">
			</div>
  ...
  <input type="file" multiple name="file" id="file"  class="input-file">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">
				...
				教师姓名：</label>
			<div class="formControls col-xs-3 col-sm-3">
				<input type="text" class="input-text" value="" placeholder="请输入教师姓名" id="name" name="name">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">
				...
				专业技能：</label>
			<div class="formControls col-xs-3 col-sm-3">
				<input type="text" class="input-text" value="" placeholder="请输入专业技能" id="major" name="major">
			</div>
		</div>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">
				...
				详&emsp;&emsp;细：</label>
			<div class="formControls col-xs-3 col-sm-3">
				<textarea name="detail" id="detail" cols="" rows="" class="textarea"  placeholder="请输入详细信息" ></textarea>
			</div>
		</div>
		...
		<div class="row cl">
			<div class="col-9 col-offset-2">
				<button class="btn btn-primary radius"  id="sub_btn" type="submit" >确认添加</button>
