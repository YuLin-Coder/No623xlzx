  ...
  <div class="fly-panel fly-panel-user" pad20>
    ...
    <div class="layui-tab layui-tab-brief" lay-filter="user">
      <ul class="layui-tab-title" id="LAY_mine">
        <li data-type="mine-jie" lay-id="index" class="layui-this">我的预约信息<%--(<span>${counts }</span>）--%></li>
            ...
            <c:forEach items="${list}" var="u" >
              <tr >
                ...
                <td class="f-14 td-manage">
                  <a href="YyzxServlet?action=delete&yid=${u.yid}&s_id=${student.id}" class="layui-btn layui-btn-sm layui-btn-danger">撤销预约</a>
                 <%-- <a style="text-decoration:none" class="layui-btn layui-btn-sm layui-btn-danger" href="YyzxServlet?action=query&yid=${u.yid}" onclick="Hui_admin_tab(this)"   title="编辑" ><i class="Hui-iconfont">&#xe6df;</i></a>--%>
                <%--  <a style="text-decoration:none" class="layui-btn layui-btn-sm layui-btn-danger"  href="YyzxServlet?action=delete&id=${u.yid}&s_id=${student.id}" >撤销预约</a>--%>
                </td>
            ...
            <%--<c:forEach items="${commentList}" var="vo">
              <tr>
                ...
                <th style="text-align: center;">
                  <a href="CommentServlet?action=deleteMyComment&id=${vo.id}" class="layui-btn layui-btn-sm layui-btn-danger">删除</a>
