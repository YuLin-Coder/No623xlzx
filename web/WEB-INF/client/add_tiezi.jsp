      ...
      <div class="layui-tab layui-tab-brief" lay-filter="user">
        ...
        <div class="layui-form layui-tab-content" id="LAY_ucm" style="padding: 20px 0;">
          <div class="layui-tab-item layui-show">
            <form action="TieziServlet?action=add" method="post">
              ...
              <div class="layui-form-item layui-form-text">
                <div class="layui-input-block" id="test-editor">
                  ...
                  <textarea name="content" id="content" placeholder="请输入帖子内容"   class="layui-textarea" id="LAY_demo1" style="display: none;"></textarea>
              </div>
              </div>
