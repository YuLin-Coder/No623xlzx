...
<div class="page-container">
	<div class="text-c">		
        <form action="ReplyServlet?action=findByMap" method="post">

			<input type="text" name="content" id="content" placeholder="根据回复内容查询" style="width:250px" class="input-text">
...
&lt;%&ndash;	<a class="btn btn-primary radius" title="添加教师信息"  onclick="Hui_admin_tab(this)" href="ReplyServlet?action=toAddTeacher"><i class="Hui-iconfont">&#xe600;</i> 添加心理老师</a>&ndash;%&gt;
...
function del_row(obj,id){
    ...
    if(confirm("您确定要删除该条记录吗？")){
        //访问路径
        location.href="${pageContext.request.contextPath}/ReplyServlet?action=delete&id="+id;
    }
}
