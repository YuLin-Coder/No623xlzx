...
<div class="page-container">
	<form action="YyzxServlet?action=add" method="post" class="form form-horizontal" >
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-3 col-sm-3">
				<input type="text" class="input-text" value="${tname}" placeholder="请输入预约老师" id="tname" name="tname" readonly>
			</div>
		...
		<div class="row cl">
			<div class="col-9 col-offset-2">
				<button class="btn btn-primary radius"  id="sub_btn" type="submit" >确认预约</button>
